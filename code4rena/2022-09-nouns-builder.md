...
| - | - | - |
| M-01 | Possible for funds to get stuck in the Auction contract | Medium |
| M-02 | Founder percentage larger than 255 will break minting of tokens | Medium |
| M-03 | Founders might receive less tokens than their specified percentage of token ownership | Medium |
